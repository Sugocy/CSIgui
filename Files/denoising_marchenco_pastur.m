function denoised_patch = denoising_marchenco_pastur(inpMat)
...
% eigenvalues.
%
% The returned denoised_patch shoudl be iterativly summated and divided by 
...
[U, S, V]= svd(inpMat,'econ'); % S = square roots of eigen values AA'|A'A
