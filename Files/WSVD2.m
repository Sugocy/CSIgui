...
if nargin < 2 % calculate noise-covariance matrix using data
...
% Coil amplitudes
A = v(:,1)'/scaleMatrixFft;
% A = v(:,1)' * invScaleMatrixFft;
...
% W = 0.5 * inv(noiseCov) * A' * conj(svdRescale) * svdRescale;
